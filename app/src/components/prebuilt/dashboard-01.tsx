...
export function Dashboard01() {
  ...
  const inActive = Object.keys(allSubscriptions || {}).length === 0
      ...
      <main className="flex flex-1 flex-col gap-4 p-4 md:gap-8 md:p-8">
        <div className="grid gap-4 md:grid-cols-3 md:gap-8 lg:grid-cols-3">
          <Card x-chunk="dashboard-01-chunk-0">
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground">
                {!inActive ? "+100% from last month" : undefined}
              </p>
            </CardContent>
          </Card>
          <Card x-chunk="dashboard-01-chunk-1">
            ...
            <CardContent>
              <div className="text-2xl font-bold">
                {Object.keys(allSubscriptions || {}).length}
              </div>
              <p className="text-xs text-muted-foreground">
                {!inActive ? "+100% from last month" : undefined}
              </p>
        ...
        <Card className="xl:col-span-2" x-chunk="dashboard-01-chunk-4">
          <CardHeader className="flex flex-row items-center">
            <div className="grid gap-2">
              ...
              <CardDescription>
                Active subscriptions from your services.
              </CardDescription>
            </div>
          ...
          {Object.keys(allSubscriptions || {}).length === 0 ? (
            <div className="p-4">
              <Notice text="There are currently no subscribers to any of your services :(" />
            </div>
          ) : (
            <CardContent>
              <Table>
                    ...
                    <TableRow>
                      ...
                      <TableCell className="text-right">
                        <Badge className="text-xs" variant="outline">
                          $
                          {formatEther(subscription.service.subscriptionAmount)}
                        </Badge>
                      </TableCell>
                    </TableRow>
                  ))}
